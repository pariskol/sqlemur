...
public class SqlConnector {
    ...
    public void executeQuery(Connection conn, String query, List<Object> params, ResultSetAction action)
            throws SQLException {
        try (var statement = prepareStatementWithParams(conn, query, params); var rset = statement.executeQuery();) {
            while (rset.next()) {
                action.onResultSet(rset);
            }
        }
    ...
    /**
     * Executes query. It tries to map rows to map. You have to cast the result. It throws unchecked exceptions.
     *
     */
    ...
    /**
     * Checks if automatic transformation of db columns names to camel case is active.
     *
     * @return
     */
    ...
    /**
     * Executes query. It tries to map rows to the given class. You have to cast the result. It throws unchecked exceptions.
     *
     */
    ...
    /**
     * Executes query with the provided connection. It tries to map rows to the given class. You have to cast the result. It throws unchecked exceptions.
     *
     */
    ...
    /**
     * Executes query with provided connection. It tries to map rows to the given class. You have to cast the result. It throws unchecked exceptions.
     *
     * @param <T>
     *
     */
    ...
    /**
     * Executes query. It tries to map first row of result set to a map. Run this if you expect your query to have a single row result set. You have to cast the result. It throws unchecked exceptions.
     *
     */
    ...
    public Map<String, Object> executeQueryToMap(String query, List<Object> params) throws SQLException {
        try (var conn = dataSource.getConnection(); var statement = prepareStatementWithParams(conn, query, params); var rset = statement.executeQuery();) {
            while (rset.next()) {
                return map(rset);
            }
        }
    ...
    /**
     * Executes query. It tries to map first row of result set to the given class. Run this if you expect your query to have a single row result set. You have to cast the result. It throws unchecked exceptions.
     *
     */
    ...
    /**
     * Executes query with the provided connection. It tries to map first row of result set to the given class. Run this if you expect your query to have a single row result set. You have to cast the result. It throws unchecked exceptions.
     *
     */
    ...
    public int executeUpdate(String query, List<Object> params) throws SQLException {
        try (var conn = dataSource.getConnection(); var statement = prepareStatementWithParams(conn, query, params);) {
