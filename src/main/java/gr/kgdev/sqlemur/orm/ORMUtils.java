...
public class ORMUtils {
    ...
    /**
     * Maps a row of result set into the given class (which has @DTO annotation and its fields have @Column annotation). Database's column types and class fields must be type compatible.
     *
     * @param rset
     * @param clazz
     * @return
    ...
    /**
     * Maps a row of result set into a LinkedHashMap. Throws unchecked exception. Use this if a more generic exception handling system exists.
     *
     * @param rset
     * @return HashMap
    ...
    /**
     * Maps a row of result set into the given class (which has @DTO annotation and its fields have @Column annotation). Database's column types and class fields must be type compatible. Throws unchecked exception. Use this if a more generic exception handling system exists.
     *
     * @param rset
     * @param clazz
     * @return
